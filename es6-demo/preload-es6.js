...
var Preload = function Preload(opts) {
	...
	this.opts = {
		...
		config: {
			...
			timeOutCB: opts.loadingOverTimeCB || function () {} }
...
Preload.prototype = {
	...
	_load: function _load(res, callback, length) {
		var self = this,
		    opts = self.opts,
		    params = self.params;
 ...
 *
 */
	syncGetData: function syncGetData(url, callback) {
		var self = this,
		    opts = self.opts,
		    params = self.params;
 ...
 *
 */
	asynGetData: function asynGetData(url) {
		var self = this,
		    opts = self.opts,
		    params = self.params;
